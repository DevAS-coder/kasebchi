...
const IntroSection = () => {
  ...
  return (
    <section 
      id="intro-section" 
      className="relative py-24 bg-gradient-to-b from-white via-coffee-light to-white dark:from-coffee-dark-bg dark:via-coffee-dark-accent dark:to-coffee-dark-bg border-b-2 border-primary/20 overflow-hidden"
    >
      {/* Decorative pattern */}
