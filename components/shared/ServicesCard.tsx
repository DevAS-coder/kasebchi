...
function ServicesCard({service} : {service : TSERVICE}) {
    return (
        <div className='flex flex-col justify-center items-center transition-all duration-300 cursor-pointer bg-gray-200 dark:bg-white/10 backdrop-blur-lg rounded-3xl w-[15rem] lg:w-[20rem] h-[15rem] hover:scale-105'>
