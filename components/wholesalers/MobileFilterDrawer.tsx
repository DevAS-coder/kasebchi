...
const MobileFilterDrawer = ({
  ...
  if (!isOpen) {
    return (
      <Button 
        variant="outline" 
        className="md:hidden flex gap-2 dark:border-gray-700 dark:text-gray-300"
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 md:hidden">
      <div className="bg-white dark:bg-gray-800 h-full w-4/5 max-w-md overflow-auto animate-slide-in-right p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold flex items-center gap-2 dark:text-gray-200">
